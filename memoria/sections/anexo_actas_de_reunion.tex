...
Las actas recogidas en este anexo reflejan el estado del proyecto y las decisiones discutidas en el momento de cada reunión. Algunas decisiones técnicas iniciales evolucionaron durante el desarrollo, por lo que la solución final válida es la descrita en los capítulos de diseño, implementación y despliegue.
...
Se comentan los objetivos del anteproyecto, que incluyen: listado de eventos con información detallada, posibilidad de que los usuarios añadan eventos sujetos a moderación, integración de mapa, subida de imágenes en vivo, reseñas y valoraciones, recomendaciones personalizadas y notificaciones dentro de la aplicación.
...
Se revisan las decisiones tecnológicas recogidas en el anteproyecto: React Native para el frontend móvil, backend con Node.js y NestJS, PostgreSQL con PostGIS para datos geoespaciales, Firebase Authentication para la autenticación, Cloudinary para la gestión de imágenes y OpenStreetMap integrado mediante \texttt{react-native-maps} para mapas.
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Módulo de recomendaciones personalizadas y notificaciones dentro de la aplicación.
    \end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Búsqueda y Visualización Geográfica:} Implementado el mapa con filtros de proximidad codificados por colores (verde, amarillo, rojo) y enlace directo a aplicaciones externas de mapas, además de filtrados fuera del mapa interactivo por proximidad.
\end{itemize}
...
\begin{itemize}
    ...
    \item Próxima reunión propuesta: 17 de abril de 2026.
\end{itemize}
...
\textbf{Observaciones:}
\begin{itemize}
    \item Se solicita añadir un apartado específico de actores del sistema (tipos de usuarios y diagrama de actores).
...
\begin{itemize}
    \item Se solicita añadir un diagrama conceptual independiente del tecnológico.
...
Se identifican elementos a completar antes de la entrega: actas de reuniones, reporte de horas, resultados de pruebas y uso por usuarios piloto. Se recomienda incluir feedback de usuarios y evidencias del sistema en uso.
...
\begin{itemize}
    ...
    \item Añadir métricas, datos reales y anexos pendientes de completar en ese momento.
...
\begin{itemize}
    ...
    \item Completar anexos (actas, reporte de horas, pruebas y feedback de usuarios).
