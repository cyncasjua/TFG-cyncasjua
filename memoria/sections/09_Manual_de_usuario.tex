...
El rol de administrador dispone de funcionalidades específicas para mantener la organización global del sistema. Estas funciones se encuentran disponibles desde el menú lateral y se orientan a la consulta de estadísticas, la gestión de usuarios, la gestión de categorías y el mantenimiento de eventos importados.

El panel de administración se divide en tres pestañas. La pestaña \textit{Estadísticas} muestra el número total de usuarios, el total de eventos, los eventos aprobados, pendientes y rechazados, y separa los eventos importados por scraping de los creados manualmente por usuarios. La pestaña \textit{Usuarios} permite modificar roles y eliminar cuentas cuando sea necesario. La pestaña \textit{Scraping} permite restablecer los eventos importados automáticamente para regenerar el catálogo externo.

Además, existe una pantalla específica para la creación, edición y eliminación de categorías, fundamentales para la clasificación de eventos y preferencias.
...
La sección \textit{Mis eventos} permite al creador consultar, editar y eliminar las actividades que ha generado. Esta pantalla resulta útil para controlar el estado de los eventos y adaptar su configuración con el tiempo.
...
El rol de moderador se encarga de revisar aquellos eventos públicos que todavía no han sido validados para su publicación y de supervisar el conjunto de eventos públicos ya aprobados. Esta funcionalidad ayuda a mantener la coherencia y fiabilidad de la plataforma.

La pantalla de moderación se organiza en dos pestañas. La primera muestra los eventos pendientes de aprobación, desde donde pueden editarse si fuera necesario y aprobarse o rechazarse. La segunda pestaña lista todos los eventos públicos ya aprobados, permitiendo al moderador editarlos o eliminarlos en cualquier momento sin afectar a eventos privados.
...
Las notificaciones permiten al usuario recibir información relevante sin necesidad de revisar manualmente el estado de sus eventos o actividades. Estas notificaciones pueden referirse a la aprobación o rechazo de un evento creado, recordatorios previos a la celebración de una actividad, eventos cercanos según la ubicación o nuevos seguidores. Al entrar salen marcadas como nuevas, se pueden pulsar para cambiar su estado y se pueden eliminar mediante el botón correspondiente. Además, algunas notificaciones incorporan una acción contextual: las notificaciones de seguidores permiten abrir directamente el perfil de la persona que ha empezado a seguir al usuario, mientras que las notificaciones asociadas a eventos permiten acceder al detalle del evento.
...
Además del chat asociado a eventos, la aplicación incorpora un módulo de amistad y mensajería privada entre usuarios. Desde la sección de amigos se pueden buscar usuarios y consultar cuatro apartados diferenciados: \textit{Seguidores}, con todas las personas que siguen al usuario; \textit{Seguidos}, con las personas a las que sigue; \textit{Amigos}, con las relaciones mutuas en las que ambos usuarios se siguen; y \textit{Buscar}, para localizar nuevos perfiles. De esta forma, un usuario que pasa a ser seguido de vuelta no desaparece del listado de seguidores, sino que también queda reflejado como amistad mutua en la pestaña correspondiente.

Al acceder al perfil de otro usuario se puede seguirlo o dejar de seguirlo, iniciar una conversación privada y consultar los eventos a los que asiste. Los contadores de seguidores y seguidos del perfil son interactivos y abren una pantalla independiente con la lista concreta de usuarios correspondiente. La mensajería privada también puede iniciarse pulsando sobre un usuario desde el chat del evento o desde la lista de asistentes. Se podrán enviar mensajes, imágenes y, si se dejan pulsados, eliminarlos.
