...
\begin{itemize}
    ...
    \item \textbf{Impacto de las fechas del scraping en el motor de recomendaciones} \textit{(Fase 3 – Sprint 5)}: los problemas de normalización de fechas descritos en el punto anterior tuvieron también un efecto directo sobre el sistema de recomendaciones, cuyo desarrollo se concentró en el Sprint 5. Dicho sistema utiliza la proximidad temporal de los eventos como uno de los factores de puntuación, por lo que eventos con fechas incorrectamente extraídas o mal normalizadas producían recomendaciones erróneas o incoherentes. Fue necesario depurar y corregir los datos ya persistidos y ajustar la lógica del algoritmo para gestionar con mayor robustez los casos en que la fecha de un evento procede del scraping, añadiendo validaciones adicionales antes de incorporarlos al cálculo de relevancia. Esta incidencia supuso una desviación de aproximadamente 4--5 horas adicionales sobre las 12--14 horas estimadas para el algoritmo de recomendaciones.
