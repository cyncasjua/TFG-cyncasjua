...
\item Listado de usuarios seguidos en la pestaña \textit{Siguiendo}.
\item Listado de seguidores pendientes de correspondencia en la pestaña \textit{Seguidores}.
...
Además del chat asociado a eventos, la aplicación incorpora un módulo de amistad y mensajería privada entre usuarios. Desde la sección de amigos se pueden buscar usuarios y consultar dos listados: \textit{Siguiendo}, con las personas a las que sigue el usuario, y \textit{Seguidores}, con las personas que le siguen pero a las que todavía no sigue. Si el usuario empieza a seguir a alguien que aparecía en \textit{Seguidores}, esa persona pasa a mostrarse en \textit{Siguiendo}.

Al acceder al perfil de otro usuario se puede seguirlo o dejar de seguirlo, iniciar una conversación privada y consultar los eventos a los que asiste. La mensajería privada también puede iniciarse pulsando sobre un usuario desde el chat del evento o desde la lista de asistentes. Se podrán enviar mensajes, imágenes y, si se dejan pulsados, eliminarlos.
