...
El rol de moderador se encarga de revisar aquellos eventos públicos que todavía no han sido validados para su publicación y de supervisar eventos públicos en un listado independiente. Esta funcionalidad ayuda a mantener la coherencia y fiabilidad de la plataforma.

Desde la pantalla de moderación pueden consultarse dos listados: los eventos pendientes de aprobación y todos los eventos públicos editables. Los eventos pendientes se mantienen en su listado propio, desde donde pueden editarse si fuera necesario y aprobarse o rechazarse. El listado de eventos públicos permite al moderador editar eventos públicos en cualquier momento, sin afectar a eventos privados. Además, desde la pantalla de edición el moderador puede eliminar eventos públicos cuando sea necesario.
