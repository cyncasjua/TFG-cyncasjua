...
La distribución se realizó mediante \textbf{Expo Go}, que permite instalar y ejecutar la aplicación directamente desde un enlace sin necesidad de publicarla en las tiendas oficiales. Se compartió el enlace con un grupo de usuarios voluntarios de distintos perfiles y con diferentes dispositivos.
...
\begin{itemize}
    \item \textbf{Módulo de amigos}: varios usuarios echaron en falta una sección específica para gestionar sus contactos dentro de la aplicación: ver qué eventos tienen planeados sus amigos, recibir sugerencias de planes basadas en los gustos de personas de confianza y poder enviar invitaciones directas a eventos. Esta funcionalidad complementaría el sistema de seguidores ya existente con una dimensión más cercana y social, similar a la que ofrecen redes sociales orientadas al ocio. Se ha incluido en la sección de trabajo futuro del capítulo de conclusiones.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Módulo social como diferenciador}: el chat de evento, los mensajes privados y la posibilidad de ver qué amigos asisten a los mismos eventos fueron los aspectos valorados como más novedosos y útiles respecto a otras aplicaciones de eventos.
