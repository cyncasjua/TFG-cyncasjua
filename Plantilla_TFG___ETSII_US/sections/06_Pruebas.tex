...
\begin{longtable}{|p{0.5cm}|p{6.5cm}|p{2.5cm}|p{5cm}|}
\hline
...
\begin{itemize}
    ...
    \item \textbf{Entorno desplegado}: backend desplegado en Google Cloud Run con base de datos en Cloud SQL. Frontend distribuido mediante \textbf{Expo Go}, probado sobre un \textbf{iPhone 16 Pro} con iOS. Se ha verificado que todos los módulos de la aplicación se abren correctamente, incluyendo el mapa (OpenStreetMap), el chat en tiempo real y las notificaciones.
\end{itemize}
