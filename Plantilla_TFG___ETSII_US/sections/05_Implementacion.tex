...
La ubicación de los eventos se almacena en PostgreSQL como un punto geográfico compatible con PostGIS mediante TypeORM, utilizando el sistema de referencia SRID 4326. El siguiente fragmento muestra la definición del campo en la entidad \texttt{Event}:
